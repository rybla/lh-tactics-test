...
\paragraph{Practicality} Proof search can be a very inefficient process, so it
was essential for the tool to derive minimal proof terms that can be easily
