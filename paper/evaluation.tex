...
% The properties are relatively basic properties about the natural numbers, lists
% of natural numbers or pairs of natural numbers, and trees of natural numbers.
...
\begin{itemize}
  \item percent of inductive proofs that were proven with just ``induct x1; ... induct xN''
...
\begin{itemize}
  \item \textit{No polymorphism for \LC{auto}}. The \LC{auto} macro cannot
  ...
  guaranteed to find the subset of the \LC{auto}-generated \textit{exp}s that
  ...
  geneated is too large to be pruned in a reasonable amount of time. \todo{how
  to qualify this formally? just pick a time limit?}
  
  \item \textit{No \LC{auto} hints with refined argument types.} If an \LC{auto}
