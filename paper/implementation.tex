...
\begin{array}{l}
  ...
  \overline{
    ...
    \macroHole
      {(\Gamma \cup \{\overline{y_{i,j}:\beta_{i,j}}\}) \setminus \{x:\alpha\}}
      {\Rho[ x \mapsto \{\overline{y_{i,j}:\beta_{i,j}}\} ]};
  }
\\[1em]
  \Gamma \vdash e : \alpha \\
  ...
  \overline{
    c_i ~ \overline{y_{i,j}} ~ \rightarrow ~ 
    \macroHole
      {\Gamma \cup \{\overline{y_{i,j}:\beta_{i,j}}\}}
      {\Rho};
  }
\\[1em]
...
% TODO: write table of rules in mathematical notation
\begin{verbatim}
