...
\begin{itemize}
  ...
  Note that if a sequence of macros given in macro declaration (i.e. \textit{decl-macro}) does \textit{not} end in an evidence macro, then an \TC{auto} macro is included implicitly at the end of the sequence.
